import { FacebookIcon, GitHubIcon, InstagramIcon, XIcon, YouTubeIcon } from "../Icons/Icons"

// need to install tailwindcss forms "npm i @tailwindcss/forms" and add require('@tailwindcss/forms') to tailwind.config
  ...
  return (
    <footer className="bg-white" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="mx-auto max-w-[90%] xl:grid xl:grid-cols-3 xl:gap-8">
          <img
            className="h-7"
